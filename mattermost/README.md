...
The following deployments can be seen at https://github.com/lucasbasquerotto/env-base/tree/master/docs/pod/mattermost.
...
params:
  ...
  domains:
    ...
    pgadmin: "pgadmin-chat.{{ params.your_domain }}"
    adminer: "adminer-chat.{{ params.your_domain }}"
